                    ...
                    <div className="mx-auto py-4 font-bold">
                        ...
                        <div className="flex gap-4 font-kanit">
                            <div className="desktop:py-0 laptop:py-0 hover:cursor-pointer">
                                <div className="before:w-[15rem] tooltip tooltip-bottom [--tooltip-color:#82c4bd] [--tooltip-text-color:#FCFBB6] flex items-center" data-tip={`${squadType} in ${school.replace(/([a-z])([A-Z]+)/g, '$1 $2')}`}>
                                    <p className="bg-transparent border-none text-[#FCFBB6] hover:bg-transparent">Position</p>
                                </div>

                            </div>
                            <div className="desktop:py-0 laptop:py-0 hover:cursor-pointer">
                                <div className="before:w-[15rem] tooltip tooltip-bottom [--tooltip-color:#82c4bd] [--tooltip-text-color:#FCFBB6] flex items-center" data-tip={profile}>
                                    <p className="bg-transparent border-none text-[#FCFBB6] hover:bg-transparent">Profile</p>
                                </div>
                            </div> 
                            <div className="desktop:py-0 laptop:py-0 hover:cursor-pointer">
                                <div className="before:w-[15rem] tooltip tooltip-bottom [--tooltip-color:#82c4bd] [--tooltip-text-color:#FCFBB6] flex items-center" data-tip={rarity}>
