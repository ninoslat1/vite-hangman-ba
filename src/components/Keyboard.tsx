      ...
      {KEYS.map((key) => {
        ...
        return (
          <button
            ...
            className={`cursor-pointer bg-[#dae8ef] text-[#4776a2] hover:bg-[#4776a2] hover:text-[#dae8ef] text-xs duration-300 laptop:text-lg desktop:text-lg font-bold uppercase m-2 p-2.5 rounded-lg md:col-span-2 ${isActiveLetters ? "bg-[hsl(200,100%,50%)] text-[white]" : ""} ${isInactiveLetters ? "opacity-30" : ""}`}
